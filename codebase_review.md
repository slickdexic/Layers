...
> **March 31, 2026 REL1_43 v1.5.63 release update:** Backported the 1,000px
> RichTextToolbar cap, removed stale HelpDialog debug probes, restored the
> shared `LayerDefaults` CommonJS export for Jest, and revalidated the branch
> at 11,494 passing tests. Current carried items on `REL1_43` remain P3-146
> (planned schema cleanup) and P3-148 (deferred interface cleanup).

---

## Scope & Verification

- **Branch Reviewed:** `REL1_43`
...
(92.88% statements, 11,494 tests in 168 suites), and robust security
