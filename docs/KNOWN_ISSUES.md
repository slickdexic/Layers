...
### F4. Lowercase Parser Function (FR-12)

**Status:** ⏳ PROPOSED (January 25, 2026)

Add backwards compatibility with lowercase `{{#layers: ...}}` syntax to match MediaWiki conventions. Currently only `{{#Layers:}}` (capitalized) is supported.
