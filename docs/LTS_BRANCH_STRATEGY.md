...
**`main` is the primary development and testing branch.** All new features, bug fixes, and improvements are developed and tested on `main` first. The full test suite (11,122 tests, 162 suites) runs on `main` as the source of truth.
...
main (primary)
  ...
  ├── All tests run here first (11,122 tests)
