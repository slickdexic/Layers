...
**`main` is the primary development and testing branch.** All new features, bug fixes, and improvements are developed and tested on `main` first. The full test suite (11,152 tests, 164 suites) runs on `main` as the source of truth.
...
|--------|------------------|-----------------|--------|
| **`main`** | **1.44+** | **1.5.57** | **Primary — all development and testing** |
| `REL1_43` | 1.43.x | 1.5.57 | LTS support (until Dec 2027) |
| `REL1_39` | 1.39.x - 1.42.x | 1.5.57 | Legacy LTS support (MW 1.39 EOL Dec 2025) |
...
main (primary)
  ...
  ├── All tests run here first (11,152 tests)
...
|--------|---------------|---------|
| `main` | X.Y.Z | 1.5.57 |
| `REL1_43` | X.Y.Z-REL1_43 | 1.5.57-REL1_43 |
| `REL1_39` | X.Y.Z-REL1_39 | 1.5.57-REL1_39 |
