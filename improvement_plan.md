...
refresh raised the RichTextToolbar cap to 1,000px and revalidated the
branch Jest suite. P3-146 and P3-148 remain carried.
...
- Metrics verified: 11,494 tests (168 suites), 92.88% stmt coverage
