...
> **Note:** For MediaWiki 1.39.x through 1.43.x, use the [REL1_39 branch](https://github.com/slickdexic/Layers/tree/REL1_39) (current version: **1.1.14**). The `main` branch requires MediaWiki 1.44+ (current version: **1.2.9**).
