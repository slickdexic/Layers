	...
	class DimensionRenderer {
		...
		static createDimensionLayer( x1, y1, x2, y2, options ) {
			...
			return {
				...
				strokeWidth: options.strokeWidth !== undefined ? options.strokeWidth : DEFAULTS.strokeWidth,
				...
				extensionGap: options.extensionGap !== undefined ? options.extensionGap : DEFAULTS.extensionGap,
				arrowSize: options.arrowSize !== undefined ? options.arrowSize : DEFAULTS.arrowSize,
				tickSize: options.tickSize !== undefined ? options.tickSize : DEFAULTS.tickSize,
				unit: options.unit || DEFAULTS.unit,
				scale: options.scale !== undefined ? options.scale : DEFAULTS.scale,
