( function () {
	 ...
	 */
	function CanvasEvents( canvasManager ) {
		this.cm = canvasManager;
		this.canvas = canvasManager.canvas;
		this.setup();
	}

	CanvasEvents.prototype.setup = function () {
		// Bind handlers
	...
	CanvasEvents.prototype.destroy = function () {
	...
	CanvasEvents.prototype.handleContextMenu = function ( e ) {
		e.preventDefault();
	};

	CanvasEvents.prototype.handleMouseDown = function ( e ) {
		const cm = this.cm;
	...
	CanvasEvents.prototype.handleMouseMove = function ( e ) {
		const cm = this.cm;
		const point = cm.getMousePoint( e );
	...
	CanvasEvents.prototype.handleMouseUp = function ( e ) {
		const cm = this.cm;
	...
	CanvasEvents.prototype.handleKeyDown = function ( e ) {
		const cm = this.cm;
	...
	CanvasEvents.prototype.handleKeyUp = function ( e ) {
		const cm = this.cm;
		if ( e.code === 'Space' ) {
	...
	CanvasEvents.prototype.handleTouchStart = function ( e ) {
		const cm = this.cm;
	...
	CanvasEvents.prototype.handleTouchMove = function ( e ) {
		const cm = this.cm;
		const touch = e.touches[ 0 ];
		if ( !touch ) {
			return;
	...
	CanvasEvents.prototype.handleTouchEnd = function ( e ) {
		const cm = this.cm;
	...
	CanvasEvents.prototype.handlePinchStart = function ( e ) {
		const cm = this.cm;
	...
	CanvasEvents.prototype.handlePinchMove = function ( e ) {
		const cm = this.cm;
	...
	CanvasEvents.prototype.handlePinchEnd = function () {
		const cm = this.cm;
		cm.isPinching = false;
	...
	CanvasEvents.prototype.handleDoubleTap = function () {
		const cm = this.cm;
