...
( function () {
	...
	/**
	 * HitTestController class
	 *
	 * @class
	 * @param {Object} canvasManager Reference to parent CanvasManager
	 */
	function HitTestController( canvasManager ) {
	 ...
	 */
	HitTestController.prototype.hitTestSelectionHandles = function ( point ) {
		let handles = [];
	 ...
	 */
	HitTestController.prototype.isPointInRect = function ( point, rect ) {
	 ...
	 */
	HitTestController.prototype.getLayerAtPoint = function ( point ) {
	 ...
	 */
	HitTestController.prototype.isPointInLayer = function ( point, layer ) {
		if ( !layer ) {
			return false;
		}
	 ...
	 */
	HitTestController.prototype.isPointInRectangleLayer = function ( point, layer ) {
	 ...
	 * @return {boolean} True if hit
	 */
	HitTestController.prototype.isPointInCircle = function ( point, layer ) {
	 ...
	 * @return {boolean} True if hit
	 */
	HitTestController.prototype.isPointInEllipse = function ( point, layer ) {
		const ex = layer.x || 0;
		const ey = layer.y || 0;
	 ...
	 * @return {boolean} True if hit
	 */
	HitTestController.prototype.isPointInTextLayer = function ( point, layer ) {
	 ...
	 * @return {boolean} True if hit
	 */
	HitTestController.prototype.isPointInPath = function ( point, layer ) {
	 ...
	 * @return {boolean} True if hit
	 */
	HitTestController.prototype.isPointInPolygonOrStar = function ( point, layer ) {
	 ...
	 * @return {boolean} True if hit
	 */
	HitTestController.prototype.isPointInHighlight = function ( point, layer ) {
	 ...
	 */
	HitTestController.prototype.isPointNearLine = function ( point, x1, y1, x2, y2, tolerance ) {
	 ...
	 */
	HitTestController.prototype.pointToSegmentDistance = function ( px, py, x1, y1, x2, y2 ) {
		const dx = x2 - x1;
		const dy = y2 - y1;
	 ...
	 */
	HitTestController.prototype.isPointInPolygon = function ( point, polygonPoints ) {
		const x = point.x;
		const y = point.y;
		let inside = false;
