...
- Backend (PHP, `src/`)
  - Manifest: `extension.json` (hooks, resource modules, API modules, rights, config; requires MediaWiki >= 1.39.0)
...
- Test count (11,496 tests in 168 suites — verified March 31, 2026)
