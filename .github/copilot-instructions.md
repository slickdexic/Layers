...
- Test count (currently 9,693 tests, 150 suites)
- Coverage (92.65% statement, 83.70% branch)
- JavaScript file count (122 files total, ~110,000 lines)
