...
- Frontend (JS, `resources/`)
  ...
  - Shared modules: `LayerRenderer.js` (~788 lines), `ShadowRenderer.js` (~517 lines), `ArrowRenderer.js` (~399 lines), `TextRenderer.js` (~104 lines), `ShapeRenderer.js` (~1,028 lines)
